...
# Create a dropdown list of all movie titles
user_input = st.selectbox("🎥 Choose a movie:", sorted(df['title'].dropna().tolist()), index=None)
if user_input:
...
#  Footer
st.markdown("---")
st.caption("Thank for using Movie 4 u")
